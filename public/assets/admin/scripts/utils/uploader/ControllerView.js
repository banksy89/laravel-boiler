    ...
    return Backbone.View.extend({
        ...
        resize: function( e, file ) {
            ...
            if( this.allow_crop == true ) {
                image_display = base.get_new_croppable_image( thumbnail, this.current_name, this.current_crop, file_name, file_size, this.total_images )
            }
            else {
        ...
        handle_input: function() {
            ...
            var name = this.clicked_input.attr( 'name' ),
                ...
                button = '<input id="js-input__gallery_' + this.total_images + '" accept="image/*" type="file" name="' + name + '" class="js-uploader__image_upload hide js-input__gallery" value="Upload Image" ' + multiple + ' />';
        ...
        delete_image: function( e, file ) {
            ...
            **/
            ...
            hidden_name = '<input type="hidden" name="removed[name][]" value="' + name + '" />';
            hidden_size = '<input type="hidden" name="removed[size][]" value="' + size + '" />';
